...
<a href="#API-Sistema-de-Lanchonete">API Sistema de Lanchonete</a>
 ...
 <a href="#Funcionalidades">Funcionalidades</a>
  <a href="#Requisitos-gerais-apresentado-pelo-cliente:">Requisitos gerais apresentado pelo cliente:</a>
  <a href="#Funcionalidades-estabelecidas-para-atender-a-demanda-do-cliente:">Requisitos gerais apresentado pelo cliente:</a>
 <a href="#Etapas:">Etapas:</a>
 <a href="#Status-61-/-65">Status 61 / 65</a>
 <a href="#Como-utilizar:">Como utilizar:</a>
  <a href="#Carregamento-do-projeto">Carregamento do projeto</a>
 <a href="#Na-operacionalização-do-sistema-obedecer-a-seguinte-sequência:">Na operacionalização do sistema obedecer a seguinte sequência:</a>
